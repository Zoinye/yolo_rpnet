...
try:
    ...
    import ultralytics
# import sys
# sys.path.append(r'E:\app\anaconda3\envs\pytorch1\Lib\site-packages\ultralytics')
...
#     def __init__(self, input_size, prov_num, alpha_num, ad_num):
#         super(LicensePlateClassifier, self).__init__()
#         self.features = nn.Sequential(
#             nn.Conv2d(input_size[0], 16, kernel_size=3, stride=1, padding=1),
#             nn.ReLU(inplace=True),
#             nn.MaxPool2d(kernel_size=2, stride=2)
#         )
#         self.classifier1 = nn.Sequential(
#             nn.Linear(16 * (input_size[1] // 2) * (input_size[2] // 2), 128),
#             nn.ReLU(inplace=True),
...
#     def __init__(self, detect_model, conf_thres=0.25, iou_thres=0.45):
#         super(CombinedModel, self).__init__()
#         self.detect_model = detect_model
#         self.license_plate_classifier = LicensePlateClassifier
...
#         detections = non_max_suppression(pred, self.conf_thres, self.iou_thres)
